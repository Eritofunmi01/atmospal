...
export default function ForecastCard({ item, unit, isToday }) {
  ...
  return (
    <div
      className={`glass flex flex-col items-center gap-1.5 py-5 px-3 text-center fade-in 
  hover:-translate-y-1 transition-transform duration-200 
  min-w-[130px] w-[130px] md:w-auto md:min-w-0 flex-shrink-0 md:flex-shrink
  snap-start ${isToday ? "forecast-today" : ""}`}
    >
      <p
      ...
      <p
        className="text-[0.68rem] capitalize leading-tight"
